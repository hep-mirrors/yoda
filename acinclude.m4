dnl TO WHOEVER HAS ACCESS: This file should be renamed cython.m4. It was taken
dnl from the python bindings to the Enlightenment foundation libraries, and was
dnl part of a GPL package. I have included this file to fix the build.
dnl
dnl
