...
class Dbn1D(_object):
    __swig_setmethods__ = {}
    __setattr__ = lambda self, name, value: _swig_setattr(self, Dbn1D, name, value)
    __swig_getmethods__ = {}
    __getattr__ = lambda self, name: _swig_getattr(self, Dbn1D, name)
    __repr__ = _swig_repr
    def __init__(self, *args): 
        this = _yodawrap.new_Dbn1D(*args)
        try: self.this.append(this)
        except: self.this = this
    def fill(self, *args): return _yodawrap.Dbn1D_fill(self, *args)
    def reset(self): return _yodawrap.Dbn1D_reset(self)
    def scaleW(self, *args): return _yodawrap.Dbn1D_scaleW(self, *args)
    def scaleX(self, *args): return _yodawrap.Dbn1D_scaleX(self, *args)
    def mean(self): return _yodawrap.Dbn1D_mean(self)
    def xMean(self): return _yodawrap.Dbn1D_xMean(self)
    def variance(self): return _yodawrap.Dbn1D_variance(self)
    def xVariance(self): return _yodawrap.Dbn1D_xVariance(self)
    def stdDev(self): return _yodawrap.Dbn1D_stdDev(self)
    def xStdDev(self): return _yodawrap.Dbn1D_xStdDev(self)
    def stdErr(self): return _yodawrap.Dbn1D_stdErr(self)
    def xStdErr(self): return _yodawrap.Dbn1D_xStdErr(self)
    def numEntries(self): return _yodawrap.Dbn1D_numEntries(self)
    def effNumEntries(self): return _yodawrap.Dbn1D_effNumEntries(self)
    def sumW(self): return _yodawrap.Dbn1D_sumW(self)
    def sumW2(self): return _yodawrap.Dbn1D_sumW2(self)
    def sumWX(self): return _yodawrap.Dbn1D_sumWX(self)
    def sumWX2(self): return _yodawrap.Dbn1D_sumWX2(self)
    def __iadd__(self, *args): return _yodawrap.Dbn1D___iadd__(self, *args)
    def __isub__(self, *args): return _yodawrap.Dbn1D___isub__(self, *args)
    __swig_destroy__ = _yodawrap.delete_Dbn1D
    __del__ = lambda self : None;
Dbn1D_swigregister = _yodawrap.Dbn1D_swigregister
Dbn1D_swigregister(Dbn1D)

class Dbn2D(_object):
    __swig_setmethods__ = {}
    __setattr__ = lambda self, name, value: _swig_setattr(self, Dbn2D, name, value)
    __swig_getmethods__ = {}
    __getattr__ = lambda self, name: _swig_getattr(self, Dbn2D, name)
    __repr__ = _swig_repr
    def __init__(self, *args): 
        this = _yodawrap.new_Dbn2D(*args)
        try: self.this.append(this)
        except: self.this = this
    def fill(self, *args): return _yodawrap.Dbn2D_fill(self, *args)
    def reset(self): return _yodawrap.Dbn2D_reset(self)
    def scaleW(self, *args): return _yodawrap.Dbn2D_scaleW(self, *args)
    def scaleX(self, *args): return _yodawrap.Dbn2D_scaleX(self, *args)
    def scaleY(self, *args): return _yodawrap.Dbn2D_scaleY(self, *args)
    def scaleXY(self, *args): return _yodawrap.Dbn2D_scaleXY(self, *args)
    def xMean(self): return _yodawrap.Dbn2D_xMean(self)
    def yMean(self): return _yodawrap.Dbn2D_yMean(self)
    def xVariance(self): return _yodawrap.Dbn2D_xVariance(self)
    def yVariance(self): return _yodawrap.Dbn2D_yVariance(self)
    def xStdDev(self): return _yodawrap.Dbn2D_xStdDev(self)
    def yStdDev(self): return _yodawrap.Dbn2D_yStdDev(self)
    def xStdErr(self): return _yodawrap.Dbn2D_xStdErr(self)
    def yStdErr(self): return _yodawrap.Dbn2D_yStdErr(self)
    def numEntries(self): return _yodawrap.Dbn2D_numEntries(self)
    def effNumEntries(self): return _yodawrap.Dbn2D_effNumEntries(self)
    def sumW(self): return _yodawrap.Dbn2D_sumW(self)
    def sumW2(self): return _yodawrap.Dbn2D_sumW2(self)
    def sumWX(self): return _yodawrap.Dbn2D_sumWX(self)
    def sumWY(self): return _yodawrap.Dbn2D_sumWY(self)
    def sumWX2(self): return _yodawrap.Dbn2D_sumWX2(self)
    def sumWY2(self): return _yodawrap.Dbn2D_sumWY2(self)
    def sumWXY(self): return _yodawrap.Dbn2D_sumWXY(self)
    def __iadd__(self, *args): return _yodawrap.Dbn2D___iadd__(self, *args)
    def __isub__(self, *args): return _yodawrap.Dbn2D___isub__(self, *args)
    def flipXY(self): return _yodawrap.Dbn2D_flipXY(self)
    def transformX(self): return _yodawrap.Dbn2D_transformX(self)
    def transformY(self): return _yodawrap.Dbn2D_transformY(self)
    __swig_destroy__ = _yodawrap.delete_Dbn2D
    __del__ = lambda self : None;
Dbn2D_swigregister = _yodawrap.Dbn2D_swigregister
Dbn2D_swigregister(Dbn2D)

class Bin1DDbn1D(Bin):
    __swig_setmethods__ = {}
    for _s in [Bin]: __swig_setmethods__.update(getattr(_s,'__swig_setmethods__',{}))
    __setattr__ = lambda self, name, value: _swig_setattr(self, Bin1DDbn1D, name, value)
    __swig_getmethods__ = {}
    for _s in [Bin]: __swig_getmethods__.update(getattr(_s,'__swig_getmethods__',{}))
    __getattr__ = lambda self, name: _swig_getattr(self, Bin1DDbn1D, name)
    __repr__ = _swig_repr
    def __init__(self, *args): 
        this = _yodawrap.new_Bin1DDbn1D(*args)
        try: self.this.append(this)
        except: self.this = this
    def reset(self): return _yodawrap.Bin1DDbn1D_reset(self)
    def scaleW(self, *args): return _yodawrap.Bin1DDbn1D_scaleW(self, *args)
    def scaleX(self, *args): return _yodawrap.Bin1DDbn1D_scaleX(self, *args)
    def lowEdge(self): return _yodawrap.Bin1DDbn1D_lowEdge(self)
    def xMin(self): return _yodawrap.Bin1DDbn1D_xMin(self)
    def highEdge(self): return _yodawrap.Bin1DDbn1D_highEdge(self)
    def xMax(self): return _yodawrap.Bin1DDbn1D_xMax(self)
    def edges(self): return _yodawrap.Bin1DDbn1D_edges(self)
    def width(self): return _yodawrap.Bin1DDbn1D_width(self)
    def focus(self): return _yodawrap.Bin1DDbn1D_focus(self)
    def midpoint(self): return _yodawrap.Bin1DDbn1D_midpoint(self)
    def xMean(self): return _yodawrap.Bin1DDbn1D_xMean(self)
    def xVariance(self): return _yodawrap.Bin1DDbn1D_xVariance(self)
    def xStdDev(self): return _yodawrap.Bin1DDbn1D_xStdDev(self)
    def xStdError(self): return _yodawrap.Bin1DDbn1D_xStdError(self)
    def numEntries(self): return _yodawrap.Bin1DDbn1D_numEntries(self)
    def effNumEntries(self): return _yodawrap.Bin1DDbn1D_effNumEntries(self)
    def sumW(self): return _yodawrap.Bin1DDbn1D_sumW(self)
    def sumW2(self): return _yodawrap.Bin1DDbn1D_sumW2(self)
    def sumWX(self): return _yodawrap.Bin1DDbn1D_sumWX(self)
    def sumWX2(self): return _yodawrap.Bin1DDbn1D_sumWX2(self)
    def __iadd__(self, *args): return _yodawrap.Bin1DDbn1D___iadd__(self, *args)
    def __isub__(self, *args): return _yodawrap.Bin1DDbn1D___isub__(self, *args)
    def merge(self, *args): return _yodawrap.Bin1DDbn1D_merge(self, *args)
    def add(self, *args): return _yodawrap.Bin1DDbn1D_add(self, *args)
    def subtract(self, *args): return _yodawrap.Bin1DDbn1D_subtract(self, *args)
    __swig_destroy__ = _yodawrap.delete_Bin1DDbn1D
    __del__ = lambda self : None;
Bin1DDbn1D_swigregister = _yodawrap.Bin1DDbn1D_swigregister
Bin1DDbn1D_swigregister(Bin1DDbn1D)

class HistoBin1D(Bin1DDbn1D):
    __swig_setmethods__ = {}
    for _s in [Bin1DDbn1D]: __swig_setmethods__.update(getattr(_s,'__swig_setmethods__',{}))
    __setattr__ = lambda self, name, value: _swig_setattr(self, HistoBin1D, name, value)
    __swig_getmethods__ = {}
    for _s in [Bin1DDbn1D]: __swig_getmethods__.update(getattr(_s,'__swig_getmethods__',{}))
...
class Histo1D(AnalysisObject):
    ...
    def mergeBins(self, *args): return _yodawrap.Histo1D_mergeBins(self, *args)
    def rebin(self, *args): return _yodawrap.Histo1D_rebin(self, *args)
    ...
    def addBin(self, *args): return _yodawrap.Histo1D_addBin(self, *args)
    def eraseBin(self, *args): return _yodawrap.Histo1D_eraseBin(self, *args)
...
class Histo2D(AnalysisObject):
    ...
    def scaleXY(self, scaleX = 1.0, scaleY = 1.0): return _yodawrap.Histo2D_scaleXY(self, scaleX, scaleY)
    def addBin(self, *args): return _yodawrap.Histo2D_addBin(self, *args)
    def mergeBins(self, *args): return _yodawrap.Histo2D_mergeBins(self, *args)
    def eraseBin(self, *args): return _yodawrap.Histo2D_eraseBin(self, *args)
    def rebin(self, *args): return _yodawrap.Histo2D_rebin(self, *args)
    def lowEdgeX(self): return _yodawrap.Histo2D_lowEdgeX(self)
    def xMin(self): return _yodawrap.Histo2D_xMin(self)
    def lowEdgeY(self): return _yodawrap.Histo2D_lowEdgeY(self)
    def yMin(self): return _yodawrap.Histo2D_yMin(self)
    def highEdgeX(self): return _yodawrap.Histo2D_highEdgeX(self)
    def xMax(self): return _yodawrap.Histo2D_xMax(self)
    def highEdgeY(self): return _yodawrap.Histo2D_highEdgeY(self)
    def yMax(self): return _yodawrap.Histo2D_yMax(self)
    ...
    def numBinsTotal(self): return _yodawrap.Histo2D_numBinsTotal(self)
    def numBins(self): return _yodawrap.Histo2D_numBins(self)
    def numBinsX(self): return _yodawrap.Histo2D_numBinsX(self)
    def numBinsY(self): return _yodawrap.Histo2D_numBinsY(self)
    ...
    def __eq__(self, *args): return _yodawrap.Histo2D___eq__(self, *args)
    def __ne__(self, *args): return _yodawrap.Histo2D___ne__(self, *args)
    def cutterX(self, *args): return _yodawrap.Histo2D_cutterX(self, *args)
    def cutterY(self, *args): return _yodawrap.Histo2D_cutterY(self, *args)
    __swig_destroy__ = _yodawrap.delete_Histo2D
    __del__ = lambda self : None;
Histo2D_swigregister = _yodawrap.Histo2D_swigregister
Histo2D_swigregister(Histo2D)

class Bin1DDbn2D(Bin):
    __swig_setmethods__ = {}
    for _s in [Bin]: __swig_setmethods__.update(getattr(_s,'__swig_setmethods__',{}))
    __setattr__ = lambda self, name, value: _swig_setattr(self, Bin1DDbn2D, name, value)
    __swig_getmethods__ = {}
    for _s in [Bin]: __swig_getmethods__.update(getattr(_s,'__swig_getmethods__',{}))
    __getattr__ = lambda self, name: _swig_getattr(self, Bin1DDbn2D, name)
    __repr__ = _swig_repr
    def __init__(self, *args): 
        this = _yodawrap.new_Bin1DDbn2D(*args)
        try: self.this.append(this)
        except: self.this = this
    def reset(self): return _yodawrap.Bin1DDbn2D_reset(self)
    def scaleW(self, *args): return _yodawrap.Bin1DDbn2D_scaleW(self, *args)
    def scaleX(self, *args): return _yodawrap.Bin1DDbn2D_scaleX(self, *args)
    def lowEdge(self): return _yodawrap.Bin1DDbn2D_lowEdge(self)
    def xMin(self): return _yodawrap.Bin1DDbn2D_xMin(self)
    def highEdge(self): return _yodawrap.Bin1DDbn2D_highEdge(self)
    def xMax(self): return _yodawrap.Bin1DDbn2D_xMax(self)
    def edges(self): return _yodawrap.Bin1DDbn2D_edges(self)
    def width(self): return _yodawrap.Bin1DDbn2D_width(self)
    def focus(self): return _yodawrap.Bin1DDbn2D_focus(self)
    def midpoint(self): return _yodawrap.Bin1DDbn2D_midpoint(self)
    def xMean(self): return _yodawrap.Bin1DDbn2D_xMean(self)
    def xVariance(self): return _yodawrap.Bin1DDbn2D_xVariance(self)
    def xStdDev(self): return _yodawrap.Bin1DDbn2D_xStdDev(self)
    def xStdError(self): return _yodawrap.Bin1DDbn2D_xStdError(self)
    def numEntries(self): return _yodawrap.Bin1DDbn2D_numEntries(self)
    def effNumEntries(self): return _yodawrap.Bin1DDbn2D_effNumEntries(self)
    def sumW(self): return _yodawrap.Bin1DDbn2D_sumW(self)
    def sumW2(self): return _yodawrap.Bin1DDbn2D_sumW2(self)
    def sumWX(self): return _yodawrap.Bin1DDbn2D_sumWX(self)
    def sumWX2(self): return _yodawrap.Bin1DDbn2D_sumWX2(self)
    def __iadd__(self, *args): return _yodawrap.Bin1DDbn2D___iadd__(self, *args)
    def __isub__(self, *args): return _yodawrap.Bin1DDbn2D___isub__(self, *args)
    def merge(self, *args): return _yodawrap.Bin1DDbn2D_merge(self, *args)
    def add(self, *args): return _yodawrap.Bin1DDbn2D_add(self, *args)
    def subtract(self, *args): return _yodawrap.Bin1DDbn2D_subtract(self, *args)
    __swig_destroy__ = _yodawrap.delete_Bin1DDbn2D
    __del__ = lambda self : None;
Bin1DDbn2D_swigregister = _yodawrap.Bin1DDbn2D_swigregister
Bin1DDbn2D_swigregister(Bin1DDbn2D)

class ProfileBin1D(Bin1DDbn2D):
    __swig_setmethods__ = {}
    for _s in [Bin1DDbn2D]: __swig_setmethods__.update(getattr(_s,'__swig_setmethods__',{}))
    __setattr__ = lambda self, name, value: _swig_setattr(self, ProfileBin1D, name, value)
    __swig_getmethods__ = {}
    for _s in [Bin1DDbn2D]: __swig_getmethods__.update(getattr(_s,'__swig_getmethods__',{}))
...
class Profile1D(AnalysisObject):
    ...
    def mergeBins(self, *args): return _yodawrap.Profile1D_mergeBins(self, *args)
    def rebin(self, *args): return _yodawrap.Profile1D_rebin(self, *args)
    def addBin(self, *args): return _yodawrap.Profile1D_addBin(self, *args)
    ...
    def __eq__(self, *args): return _yodawrap.Profile1D___eq__(self, *args)
    def __ne__(self, *args): return _yodawrap.Profile1D___ne__(self, *args)
...
class Scatter3D(AnalysisObject):
    ...
    def __eq__(self, *args): return _yodawrap.Scatter3D___eq__(self, *args)
    def __ne__(self, *args): return _yodawrap.Scatter3D___ne__(self, *args)
...
def subtract(*args):
  return _yodawrap.subtract(*args)
subtract = _yodawrap.subtract
...
def divide(*args):
  return _yodawrap.divide(*args)
divide = _yodawrap.divide
